...
keymongodb = process.env.MONGODB_URI //example "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
sendemail = process.env.SMTP_USER //Email SMTP
fromsendemail = process.env.SMTP_USER // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = process.env.SMTP_PASS // Password Email SMTP
domain = 'api-aetherz.xyz'// domain website tanpa http or https
...
recaptcha_key_1 = process.env.RECAPTCHA_SITE_KEY
recaptcha_key_2 = process.env.RECAPTCHA_SECRET_KEY
